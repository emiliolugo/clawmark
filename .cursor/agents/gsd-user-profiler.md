...
<reference>
@/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/references/user-profiling.md` to load:
