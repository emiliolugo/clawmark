...
Key references:
- @/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/references/ui-brand.md (display patterns)
- @/Users/emiliolugo/Code/clawmark/.cursor/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/USER-PROFILE.md"
...
```bash
cp "/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/USER-PROFILE.md" "/Users/emiliolugo/Code/clawmark/.cursor/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/emiliolugo/Code/clawmark/.cursor/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/references/user-profiling.md`
...
Reference: @/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /Users/emiliolugo/Code/clawmark/.cursor/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global .cursor/rules/" -- "Add profile to /Users/emiliolugo/Code/clawmark/.cursor/.cursor/rules/ for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/emiliolugo/Code/clawmark/.cursor/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/emiliolugo/Code/clawmark/.cursor/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/emiliolugo/Code/clawmark/.cursor/.cursor/rules/"
...
```bash
BACKUP_PATH="/Users/emiliolugo/Code/clawmark/.cursor/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/emiliolugo/Code/clawmark/.cursor/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/emiliolugo/Code/clawmark/.cursor/skills/gsd-dev-preferences/SKILL.md
  ✓ .cursor/rules/ section       <resolved claude_md_path, default ./.cursor/.cursor/rules/>
  ✓ Global .cursor/rules/        /Users/emiliolugo/Code/clawmark/.cursor/.cursor/rules/
```
