...
```
Agent(
  prompt="Read /Users/emiliolugo/Code/clawmark/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/templates/SECURITY.md`
