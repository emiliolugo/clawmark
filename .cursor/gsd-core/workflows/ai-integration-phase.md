...
<required_reading>
@/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/references/ai-frameworks.md
@/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/emiliolugo/Code/clawmark/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/emiliolugo/Code/clawmark/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/emiliolugo/Code/clawmark/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/emiliolugo/Code/clawmark/.cursor/agents/gsd-eval-planner.md for instructions.
