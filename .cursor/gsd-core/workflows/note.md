...
- **Global scope**: `/Users/emiliolugo/Code/clawmark/.cursor/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/emiliolugo/Code/clawmark/.cursor/notes/`)
...
2. Glob `/Users/emiliolugo/Code/clawmark/.cursor/notes/*.md` (if directory exists) — global notes
...
Global (/Users/emiliolugo/Code/clawmark/.cursor/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/emiliolugo/Code/clawmark/.cursor/notes/` — works in any directory
