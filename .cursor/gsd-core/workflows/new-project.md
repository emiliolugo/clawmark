...
```bash
if [ "$RUNTIME" = "codex" ]; then INSTRUCTION_FILE="AGENTS.md"; else INSTRUCTION_FILE=".claude/.cursor/rules/"; fi
```
...
Use template: /Users/emiliolugo/Code/clawmark/.cursor/gsd-core/templates/research-project/STACK.md
</output>
...
Use template: /Users/emiliolugo/Code/clawmark/.cursor/gsd-core/templates/research-project/FEATURES.md
</output>
...
Use template: /Users/emiliolugo/Code/clawmark/.cursor/gsd-core/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: /Users/emiliolugo/Code/clawmark/.cursor/gsd-core/templates/research-project/PITFALLS.md
</output>
...
Use template: /Users/emiliolugo/Code/clawmark/.cursor/gsd-core/templates/research-project/SUMMARY.md
...
- `.planning/ROADMAP.md`
- `.planning/STATE.md`
- `$INSTRUCTION_FILE` (`AGENTS.md` for Codex, `.claude/.cursor/rules/` for all other runtimes)
...
- [ ] `$INSTRUCTION_FILE` generated with GSD workflow guidance (AGENTS.md for Codex, `.claude/.cursor/rules/` otherwise; an existing hand-crafted file without GSD markers is left untouched unless `--force`)
