...
INSTALL_JS_GLOBAL="/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/emiliolugo/Code/clawmark/.cursor/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
