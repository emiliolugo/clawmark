...
ones). Reference: @/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /Users/emiliolugo/Code/clawmark/.cursor.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/bin/lib/edge-probe.cjs" \
  "/Users/emiliolugo/Code/clawmark/.cursor/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/templates/spec.md.
