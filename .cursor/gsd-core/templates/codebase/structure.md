...
- Usage: Reference from command with `@/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/emiliolugo/Code/clawmark/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/emiliolugo/Code/clawmark/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
