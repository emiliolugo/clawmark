...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/Users/emiliolugo/Code/clawmark/.cursor/.gsd-surface.json`
(sibling to `/Users/emiliolugo/Code/clawmark/.cursor/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/Users/emiliolugo/Code/clawmark/.cursor/skills/gsd-*/`.
...
(`/Users/emiliolugo/Code/clawmark/.cursor`), NOT the skills sub-directory (`/Users/emiliolugo/Code/clawmark/.cursor/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `/Users/emiliolugo/Code/clawmark/.cursor` as `configDir`. The skill dirs themselves live at
`/Users/emiliolugo/Code/clawmark/.cursor/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Cursor — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-/Users/emiliolugo/Code/clawmark/.cursor}"
SCOPE="global"
...
(i.e. `/Users/emiliolugo/Code/clawmark/.cursor/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/Users/emiliolugo/Code/clawmark/.cursor/.gsd-surface.json`
Install profile marker: `/Users/emiliolugo/Code/clawmark/.cursor/.gsd-profile`
Skill dirs: `/Users/emiliolugo/Code/clawmark/.cursor/skills/gsd-*/`
Engine module: `/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/Users/emiliolugo/Code/clawmark/.cursor/gsd-core/bin/lib/clusters.cjs`
</execution_context>
